"""
Django settings for divine_union_dev_77173 project.
...
ROOT_URLCONF = 'divine_union_dev_77173.urls'
...
WSGI_APPLICATION = 'divine_union_dev_77173.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "divine_union_dev_77173 API",
    "DESCRIPTION": "API documentation for divine_union_dev_77173 App",
    "VERSION": "v1",
}
